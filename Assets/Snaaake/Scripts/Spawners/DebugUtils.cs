...
namespace Spawners
{
    ...
    public static class DebugUtils
    {
        ...
        public static void DrawRect(Vector2 pos, float size, Color color, float duration)
        {
            DrawRect(new Vector2(pos.x - size/2, pos.y - size / 2),
                    new Vector2(pos.x + size / 2, pos.y + size / 2), color, duration);
        }
    }
